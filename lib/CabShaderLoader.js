  ...
  function CabShaderLoader( pathToShaders , pathToChunks ){
  ...
  */
  CabShaderLoader.prototype.loadShaderChunk = function( type ){
  ...
  CabShaderLoader.prototype.onChunkLoaded = function( chunk , title ){
  ...
  */
  CabShaderLoader.prototype.load = function( shader , title , type ){
  ...
  */
  CabShaderLoader.prototype.onShaderLoaded = function( shaderText , title , type ){
  ...
  CabShaderLoader.prototype._beginLoad = function(  shader , title , type  ){
    this.shadersToLoad ++;
    this.beginLoad( shader , title , type  );
  }
  
  CabShaderLoader.prototype._endLoad = function( shaderText , title , type ){
    this.shadersLoaded ++;
  ...
  CabShaderLoader.prototype.setValue = function( shader , name , value ){
  ...
  CabShaderLoader.prototype.shaderSetLoaded = function(){}
  CabShaderLoader.prototype.endLoad = function(){}
  CabShaderLoader.prototype.beginLoad = function(){}
